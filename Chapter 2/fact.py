...
else:                        #value par stop hota hai aur i ki value apne se badhati rahti hai. isme i++ nahi use hota  "+1" use hota hai jo  
 fact=1                       #jo value hum de uske barabar chalne ke liye nahi to ek kam chalega loop.
...
# def fact(n):
#  fact=1
#  for i in range (1, n + 1):   # ye function ko call karke factorial program.
#     fact=fact*i               #python me function banane ke liye "def" keyword use karte hai.
#  print(fact)
